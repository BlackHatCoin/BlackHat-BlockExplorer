    ...
    tests := []struct {
    ...
    }{
        {
            ...
            req:  socketioReq{"getInfo", []interface{}{}},
                        want: `{"result":{"blocks":225494,"testnet":true,"network":"fakecoin","subversion":"/Fakecoin:0.0.1/","coin_name":"Fakecoin","about":"BlackHat Blockchain explorer - made with TREZOR Blockbook indexer."}}`,
        },
        {
