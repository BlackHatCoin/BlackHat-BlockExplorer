...
import (
	"blockbook/bchain"
	"blockbook/bchain/coins/blackhat"
	"blockbook/common"
	"context"
	"encoding/json"
	"fmt"
...
func init() {
	BlockChainFactories["BlackHat"] = blackhat.NewBlackHatRPC
	BlockChainFactories["BlackHat Testnet"] = blackhat.NewBlackHatRPC
}
...
func (c *blockChainWithMetrics) GetCssJsTs() int {
	return c.b.GetCssJsTs()
}
