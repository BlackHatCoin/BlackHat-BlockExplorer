...
func init() {
    // BlackHat mainnet Address encoding magics
    ...
    // BlackHat testnet Address encoding magics
...
func (p *BlackHatParser) outputScriptToAddresses(script []byte) ([]string, bool, error) {
